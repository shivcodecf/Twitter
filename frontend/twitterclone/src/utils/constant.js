export const USER_API_END_POINT = "https://twitter-back1.onrender.com/api/v1/user";
export const TWEET_API_END_POINT = "https://twitter-back1.onrender.com/api/v1/tweet";
